    ...
    private void OnDisable()
{
    ...
    private readonly Matrix4x4 protanopia = new Matrix4x4(
        new Vector4(0.152286f, 0.114503f, -0.003882f, 0.0f), // Column 0
        new Vector4(1.052583f, 0.786281f, -0.048116f, 0.0f), // Column 1
        new Vector4(-0.204868f, 0.099216f, 1.051998f, 0.0f), // Column 2
